          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              ...
              <input
                ...
                className={`w-full md:pl-10 px-4 py-3 border text-sm md:text-base text-black placeholder:font-light bg-gray-50 md:bg-white rounded-md md:rounded-none focus:outline-none focus:border-purple-600 md:focus:border-black transition-colors ${
