          ...
          <div className="flex-1 min-w-0">
            ...
            >
              ...
              <button 
                ...
                className="w-full flex items-center justify-between py-3 px-5 md:px-2 hover:bg-zinc-800 active:bg-zinc-700 md:rounded-xl transition-colors group touch-manipulation min-h-[48px]"
              >
                <div className="flex items-center gap-2.5 flex-1 min-w-0">
                  <svg className="w-5 h-5 text-zinc-400 group-hover:text-white transition-colors flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" />
                  </svg>
                  <div className="flex flex-col items-start min-w-0 flex-1">
                    <span className="text-zinc-300 text-sm">Público objetivo</span>
              ...
              >
                <div className="flex items-center gap-2.5 flex-1 min-w-0">
                  ...
                  <div className="flex flex-col items-start min-w-0 flex-1">
                    <span className="text-zinc-300 text-sm">Autenticidad del contenido</span>
              ...
              >
                <div className="flex items-center gap-2.5 flex-1 min-w-0">
                  ...
                  <div className="flex flex-col items-start min-w-0 flex-1">
                    <span className="text-zinc-300 text-sm">Privacidad de votos</span>
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-2.5">
                    ...
                    <div className="flex flex-col">
                      <span className="text-zinc-300 text-sm">Allow comments</span>
              ...
              <div className="w-full py-3 px-5 md:px-2 min-h-[48px]">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-2.5">
                    ...
                    <div className="flex flex-col">
                      <span className="text-zinc-300 text-sm">Show vote count</span>
                      <span className="text-zinc-500 text-xs">
              ...
              <div className="w-full py-3 px-5 md:px-2 min-h-[48px]">
                <div className="flex items-center gap-2.5 mb-3">
                  ...
                  <div className="flex flex-col">
                    <span className="text-zinc-300 text-sm">Mature content (Sensitive media)</span>
                ...
                {matureContent === 'mild' && (
                  <p className="text-xs text-zinc-500 mt-2 pl-0 md:pl-8">Edits with blood, dark themes</p>
                )}
                {matureContent === 'strong' && (
                  <p className="text-xs text-zinc-500 mt-2 pl-0 md:pl-8">Fictional violence, disturbing content</p>
                )}
              </div>
              ...
              <div className="w-full py-3 px-5 md:px-2 min-h-[48px]">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-2.5">
                    ...
                    <div className="flex flex-col">
                      <span className="text-zinc-300 text-sm">Allow downloads</span>
              ...
              <div className="w-full py-3 px-5 md:px-2 min-h-[48px]">
                <div className="flex items-center justify-start gap-2.5 mb-2">
                  ...
                  <span className="text-zinc-300 text-sm">Share to</span>
                </div>
                <div className="flex gap-3 justify-start pl-0 md:pl-8">
                  <button className="w-10 h-10 rounded-full bg-zinc-800 hover:bg-zinc-700 active:bg-zinc-600 flex items-center justify-center transition-colors touch-manipulation">
