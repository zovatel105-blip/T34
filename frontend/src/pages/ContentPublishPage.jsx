            ...
            >
              ...
              <div className="rounded-2xl bg-zinc-800 p-4">
                ...
                <div className="flex gap-3 justify-start pl-0">
                  <button className="w-10 h-10 rounded-full bg-zinc-900 hover:bg-zinc-700 active:bg-zinc-600 flex items-center justify-center transition-colors touch-manipulation">
