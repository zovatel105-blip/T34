              ...
              {loadingStates.recentSearches ? (
                ...
                <>
                  ...
                  <div className="flex items-center justify-between px-2 pt-2 pb-3">
                    <h3 className="text-xl font-bold text-gray-900">{t('search.recentSearchesTitle')}</h3>
                    {recentSearches.length > 3 && (
                      <button
                        onClick={() => setShowAllRecentSearches(!showAllRecentSearches)}
                        className="text-[15px] font-semibold text-blue-500 hover:text-blue-600 transition-colors"
                      >
                    ...
                    {(showAllRecentSearches ? recentSearches : recentSearches.slice(0, 3)).map((recentSearch) => (
                      ...
                      >
                        ...
                        <div className="w-14 h-14 rounded-full border border-gray-200 flex items-center justify-center flex-shrink-0">
                          <Clock size={26} className="text-gray-900" strokeWidth={1.5} />
                        </div>
                        ...
                        <button
                          ...
                          className="w-9 h-9 flex items-center justify-center text-gray-400 hover:text-gray-600 flex-shrink-0"
                          aria-label="Eliminar"
                        >
