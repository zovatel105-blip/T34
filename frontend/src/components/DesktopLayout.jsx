...
const DesktopLayout = ({ children }) => {
  ...
  const navigationItems = [
    ...
    { icon: Bell, label: 'Notificaciones', path: '/notifications', active: location.pathname === '/notifications' },
    { icon: Mail, label: 'Mensajes', path: '/messages', active: location.pathname === '/messages', badge: unreadCount > 0 ? unreadCount : null },
