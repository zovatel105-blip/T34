            ...
            <div className={cn("px-4 sm:px-6 pb-4 flex-shrink-0", isMobile && isBottomNav ? "bg-white" : "")}>
              ...
              <div className="flex items-center justify-center gap-8 pt-4">
                <div className="flex items-center gap-2">
                  <VoteIcon className={cn("w-7 h-7", isMobile && isBottomNav ? "text-gray-700" : "text-white")} strokeWidth={320} filled={false} />
              ...
              {loading ? (
                ...
                <div className="flex flex-col items-center justify-center py-12 px-6">
                  <div className={cn("w-14 h-14 rounded-full flex items-center justify-center mb-3", isMobile && isBottomNav ? "bg-gray-100" : "bg-white/10")}>
                    <VoteIcon className={cn("w-9 h-9", isMobile && isBottomNav ? "text-gray-400" : "text-white/40")} strokeWidth={320} filled={false} />
                  </div>
