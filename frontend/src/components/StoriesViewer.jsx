...
const StoriesViewer = ({ storiesGroups, onClose, initialUserIndex = 0 }) => {
  ...
  return (
    <div className="fixed inset-0 z-[100000] bg-black">
      ...
      {/* Progress bars */}
      <div className="absolute top-0 left-0 right-0 z-30 px-2" style={{ paddingTop: 'calc(var(--safe-area-inset-top) + 0.5rem)' }}>
      ...
      {/* Header */}
      <div className="absolute top-0 left-0 right-0 z-30 px-4" style={{ paddingTop: 'calc(var(--safe-area-inset-top) + 1rem)' }}>
