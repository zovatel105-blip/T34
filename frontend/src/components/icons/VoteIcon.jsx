 ...
 *   - filled=false → outline (path original con dos subpaths: contorno externo
 *     e interno) → solo se ven los "laterales" del check.
 *   - filled=true  → relleno SÓLIDO (solo se renderiza el subpath externo del
 *     V, lo que pinta el interior completo manteniendo la forma exacta).
 *
 * Mantiene el viewBox 0 0 600 600 original para conservar el mismo tamaño
 * visual en todos los lugares donde se usa el icono.
 *
 * Props:
 *   - filled (bool, default true): si true rellena el interior con currentColor
