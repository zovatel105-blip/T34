 ...
 */
const VoteIcon = ({ className = '', style, strokeWidth = 500, ...props }) => (
  <svg
    ...
    {...props}
  >
    <g transform="translate(0,600) scale(0.1,-0.1)" fill="currentColor" stroke="currentColor" strokeWidth={strokeWidth} strokeLinejoin="round" strokeLinecap="round">
